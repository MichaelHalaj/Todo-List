...
class Task {
  constructor(title, description, dueDate, priority = 'none', completed = false) {
    ...
    this.formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dateFNS, 'H:ma MM/dd/yyyy');
  }
