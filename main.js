...
/**
 * There is an issue when you switch to a different project and delete a task without adding one first
 * then there is an undefined error with the project
 */
/**
